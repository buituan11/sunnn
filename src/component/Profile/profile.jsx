            ...
            <div>
                <div className="profile-tab">
                    <div className="aa container-fluid">
                        <div className="row">
                            {this.renderProfile('AA', 'Nam', '18', 'AAA', ["Tún Tún", "Trường, Phương", "Bố mẹ", "Các bạn của Sunn"], "stuff-a")}
                            {/* { this.renderProfile('BB', 'Nu', '18', 'BBB', [1,2,3,4],"stuff-b") } */}
                            <div className="col-lg-6 col-12">
                                <div className="profile-item">
                                    <p>Câu 2: Nhập mã OTP</p>
                                    <p>Tháng của chị hơn tháng của em bao nhiêu nào, tìm đáp án - đó chính là mã OTP - điền mã đó vào ô dưới đây bạn sẽ giải được câu hỏi:</p>
